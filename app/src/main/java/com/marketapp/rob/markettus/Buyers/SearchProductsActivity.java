...
public class SearchProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchET = (EditText)findViewById(R.id.search_product_name);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                ...
                .setQuery(searchRef.orderByChild("name").startAt(searchInput), Products.class)
                .build();
                ...
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent = new Intent(SearchProductsActivity.this, ProductsDetailsActivity.class);
